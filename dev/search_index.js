...
{
    "location": "generated/simulation/#Example:-Simulated-Data-1",
    "page": "Example: Simulated Data",
    "title": "Example: Simulated Data",
    "category": "section",
    "text": "DataKnots can be used to create simulated data sets, using simple range iteration and random number generation.using DataKnotsLet us plot something; we\'ll change this soon.using Plots\nx = range(0, stop=6pi, length=1000)\nplot(x, [sin.(x), cos.(x)])"
},
