...

{
    ...
    "title": "Counting",
    "category": "section",
    "text": "This example returns the number of departments in the dataset.run(ChicagoData, Count(Department))\n#=>\n│ DataKnot │\n├──────────┤\n│        2 │\n=#Using pipeline composition (>>), we can perform Count in a nested context; in this case, we count employee records within each department.run(ChicagoData, Department >> Count(Employee))\n#=>\n  │ DataKnot │\n──┼──────────┤\n1 │        2 │\n2 │        1 │\n=#In this toy dataset, we see that the 1st department, \"POLICE\", has 2 employees, while the 2nd, \"FIRE\" only has 1."
},
