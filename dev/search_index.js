...

{
    ...
    "title": "Getting Started",
    "category": "section",
    "text": "DataKnots is currently usable for contributors who wish to help grow the ecosystem. However, DataKnots is not yet usable for general audiences: with v0.1, there are no data source adapters and we lack important operators, such as Sort and Group. Many of these deficiencies were prototyped and subsequent releases will address these feature gaps incrementally."
},
...

{
    ...
    "category": "section",
    "text": "Consider a tiny cross-section of public data from Chicago, represented as nested NamedTuple and Vector objects.chicago_data_source =\n  (department = [\n    (name = \"POLICE\",\n     employee = [\n      (name = \"JEFFERY A\", position = \"SERGEANT\",\n       salary = 101442),\n      (name = \"NANCY A\", position = \"POLICE OFFICER\",\n       salary = 80016)]),\n    (name = \"FIRE\",\n     employee = [\n      (name = \"DANIEL A\", position = \"FIRE FIGHTER-EMT\",\n       salary = 95484)])],);To query this data, we convert it into a DataKnot. For shallow data structures, any knot can be converted back to native Julia datatype via the get function.using DataKnots\nchicago_data = DataKnot(chicago_data_source)\ntypeof(get(chicago_data))\n#-> NamedTuple{(:department,),⋮In this hierarchical Chicago data, the root is a NamedTuple with an entry :department, that Vector valued entry has another vector of tuples labeled :employee. The label name occurs both within the context of a department and an employee record."
},

{
    ...
    "title": "Navigation",
    "category": "section",
    "text": "To list all department names in the chicago_data knot, we use Julia\'s index notation with It.department.name. In this pipeline, It means \"use the current input\". The dotted notation lets one navigate via hierarchy.chicago_data[It.department.name]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#Navigation context matters. For example, employee tuples are not directly accessible from the root of the dataset provided. When a label can\'t be found, an appropriate error message is displayed.chicago_data[It.employee]\n#-> ERROR: cannot find employee ⋮Instead, employee tuples can be accessed by navigating though department tuples.chicago_data[It.department.employee]\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ NANCY A    POLICE OFFICER     80016 │\n3 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#Notice that nested lists traversed during navigation are flattened into a single output."
},

{
    ...
    "category": "section",
    "text": "Dotted navigations, such as It.department.name, are a syntax shorthand for the Get() primitive together with pipeline composition (>>).chicago_data[Get(:department) >> Get(:name)]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#The Get() pipeline primitive reproduces contents from a named container. Pipeline composition >> merges results from nested traversal. They can be used together creatively.chicago_data[Get(:department) >> Get(:employee)]\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ NANCY A    POLICE OFFICER     80016 │\n3 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#In this pipeline algebra, It is the identity relative to pipeline composition (>>). Since It can be mixed into any composition without changing the result, we can write:chicago_data[It >> Get(:department) >> Get(:name)]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#This motivates our clever use of It as a syntax short hand.chicago_data[It.department.name]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#This pipeline, It.department.name, could be equivalently written Get(:department) >> Get(:name)."
},

{
    ...
    "category": "section",
    "text": "To return the number of departments in this Chicago dataset we write Count(It.department). Observe that the argument provided to Count(), It.department, is itself a pipeline.chicago_data[Count(It.department)]\n#=>\n│ It │\n┼────┼\n│  2 │\n=#Using pipeline composition (>>), we can perform Count in a nested context; for this next example, let\'s count employee records within each department.chicago_data[\n  It.department >>\n  Count(It.employee)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  1 │\n=#In this output we see that the 1st department, \"POLICE\", has 2 employees, while the 2nd, \"FIRE\" only has 1. The occurrence of It within the subordinate pipeline Count(It.employee) refers to each department individually, not to the dataset as a whole."
},

{
    ...
    "category": "section",
    "text": "Returning values in tandem can be done with Record(). Let\'s improve the previous output by including each department\'s name alongside employee counts.chicago_data[\n  It.department >>\n  Record(It.name,\n         Count(It.employee))]\n#=>\n  │ department │\n  │ name    #B │\n──┼────────────┼\n1 │ POLICE   2 │\n2 │ FIRE     1 │\n=#Records can be nested. The following listing includes, for each department, employee names and their salary.chicago_data[\n  It.department >>\n  Record(It.name,\n    It.employee >>\n    Record(It.name, It.salary))]\n#=>\n  │ department                                │\n  │ name    employee                          │\n──┼───────────────────────────────────────────┼\n1 │ POLICE  JEFFERY A, 101442; NANCY A, 80016 │\n2 │ FIRE    DANIEL A, 95484                   │\n=#In this nested display, commas are used to separate fields and semi-colons separate values."
},

{
    ...
    "category": "section",
    "text": "Pipeline expressions can be named and reused. Further, the output column of these named pipelines may be labeled using Julia\'s Pair syntax (=>). Let\'s define EmployeeCount to be the number of employees in a given department.EmployeeCount =\n  :employee_count =>\n    Count(It.employee)\n\nchicago_data[\n  It.department >>\n  Record(It.name, EmployeeCount)]\n#=>\n  │ department             │\n  │ name    employee_count │\n──┼────────────────────────┼\n1 │ POLICE               2 │\n2 │ FIRE                 1 │\n=#Labels can be attached to an existing pipeline using the Label primitive. This form is handy for use in successive pipeline refinements (>>=).DeptCount = Count(It.department)\nDeptCount >>= Label(:dept_count)\n\nchicago_data[DeptCount]\n#=>\n│ dept_count │\n┼────────────┼\n│          2 │\n=#Besides providing a display title, labels also provide a way to access fields within a record.chicago_data[\n  Record(It, DeptCount) >>\n  It.dept_count]\n#=>\n│ dept_count │\n┼────────────┼\n│          2 │\n=#"
},

{
    ...
    "category": "section",
    "text": "Returning only wanted values can be done with Filter(). Here we list department names who have exactly one employee.chicago_data[\n  It.department >>\n  Filter(EmployeeCount .== 1) >>\n  Record(It.name, EmployeeCount)]\n#=>\n  │ department           │\n  │ name  employee_count │\n──┼──────────────────────┼\n1 │ FIRE               1 │\n=#In pipeline expressions, the broadcast variant of common operators, such as .== are to be used. Forgetting the period is an easy mistake to make and the resulting Julia language error message may not be helpful.chicago_data[\n  It.department >>\n  Filter(EmployeeCount == 1) >>\n  Record(It.name, EmployeeCount)]\n#=>\nERROR: AssertionError: eltype(input) <: AbstractVector\n=#Let\'s define GT100K to check if an employee\'s salary is greater than 100K. The output of this pipeline is also labeled.GT100K =\n  :gt100k =>\n    It.salary .> 100000\n\nchicago_data[\n  It.department.employee >>\n  Record(It.name, It.salary, GT100K)]\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┼\n1 │ JEFFERY A  101442    true │\n2 │ NANCY A     80016   false │\n3 │ DANIEL A    95484   false │\n=#Since Filter takes a boolean valued pipeline for an argument, we could use GTK100K to filter employees.chicago_data[\n  It.department.employee >>\n  Filter(GT100K) >>\n  It.name]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n=#"
},

{
    ...
    "category": "section",
    "text": "This data discovery could have been done incrementally, with each intermediate pipeline being fully runnable. Let\'s start OurQuery as a list of employees. We\'re not going to run it, but we could.OurQuery = It.department.employee\n#-> It.department.employeeLet\'s extend this pipeline to compute and show if the salary is over 100k. Notice how pipeline composition is tracked for us. We could run this pipeline also, if we wanted.GT100K = :gt100k => It.salary .> 100000\nOurQuery >>= Record(It.name, It.salary, GT100K)\n#=>\nIt.department.employee >>\nRecord(It.name, It.salary, :gt100k => It.salary .> 100000)\n=#Since labeling permits direct Record access, we could further extend this pipeline to filter unwanted rows.OurQuery >>= Filter(It.gt100k)\n#=>\nIt.department.employee >>\nRecord(It.name, It.salary, :gt100k => It.salary .> 100000) >>\nFilter(It.gt100k)\n=#Let\'s run it.chicago_data[OurQuery]\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┼\n1 │ JEFFERY A  101442    true │\n=#Well-tested pipelines may benefit from a Tag so that their definitions are suppressed in larger compositions.GT100K = Tag(:GT100K, :gt100k => It.salary .> 100000)\n#-> GT100KThis tagging can make subsequent compositions easier to read, when the definition of the named pipeline is not being questioned.OurQuery = It.department.employee >>\n           Record(It.name, It.salary, GT100K)\n#=>\nIt.department.employee >> Record(It.name, It.salary, GT100K)\n=#Notice that the tag (:GT100K) is distinct from the data label (:gt100k), the tag names the pipeline while the label names the output column.OurQuery >>= Filter(It.gt100k)\nchicago_data[OurQuery]\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┼\n1 │ JEFFERY A  101442    true │\n=#For the final step of our incremental construction, let\'s only show the employee\'s name that met the GT100K criteria.OurQuery >>= It.name\nchicago_data[OurQuery]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n=#"
},

{
    ...
    "category": "section",
    "text": "Aggregates, such as Count may be used directly as a pipeline, providing incremental refinement without additional nesting. In this next example, Count takes an input of filtered employees, and returns the size of its input.chicago_data[\n  It.department.employee >>\n  Filter(It.salary .> 100000) >>\n  Count]\n#=>\n│ It │\n┼────┼\n│  1 │\n=#Aggregate pipelines operate contextually. In the following example, Count is performed relative to each department.chicago_data[\n  It.department >>\n  Record(\n   It.name,\n   :over_100k =>\n     It.employee >>\n     Filter(It.salary .> 100000) >>\n     Count)]\n#=>\n  │ department        │\n  │ name    over_100k │\n──┼───────────────────┼\n1 │ POLICE          1 │\n2 │ FIRE            0 │\n=#Note that in It.department.employee >> Count, the Count pipeline aggregates the number of employees across all departments. This doesn\'t change even if we add parentheses:chicago_data[\n  It.department >> (It.employee >> Count)]\n#=>\n│ It │\n┼────┼\n│  3 │\n=#To count employees in each department, we use the Each() pipeline constructor.chicago_data[\n  It.department >>\n  Each(It.employee >> Count)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  1 │\n=#Naturally, we could use the Count() pipeline constructor to get the same result.chicago_data[\n  It.department >>\n  Count(It.employee)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  1 │\n=#Which form of an aggregate to use depends upon what is notationally convenient.  For incremental construction, being able to simply append >> Count is often very helpful.OurQuery = It.department.employee\nchicago_data[OurQuery >> Count]\n#=>\n│ It │\n┼────┼\n│  3 │\n=#"
},
...

{
    ...
    "category": "section",
    "text": "Suppose we\'d like a list of employee names together with the corresponding department name. The naive approach won\'t work, because department is not a label in the context of an employee.chicago_data[\n  It.department >>\n  It.employee >>\n  Record(It.name, It.department.name)]\n#-> ERROR: cannot find department ⋮This can be overcome by using Keep to label an expression\'s result, so that it is available within subsequent computations.chicago_data[\n  It.department >>\n  Keep(:dept_name => It.name) >>\n  It.employee >>\n  Record(It.name, It.dept_name)]\n#=>\n  │ employee             │\n  │ name       dept_name │\n──┼──────────────────────┼\n1 │ JEFFERY A  POLICE    │\n2 │ NANCY A    POLICE    │\n3 │ DANIEL A   FIRE      │\n=#This pattern also emerges with aggregate computations which need to be done in a parent scope. For example, let\'s compute employees with a higher than average salary within their department.using Statistics: mean\nchicago_data[\n  It.department >>\n  Keep(:mean_salary =>\n    mean.(It.employee.salary)) >>\n  It.employee >>\n  Filter(It.salary .> It.mean_salary)]\n#=>\n  │ employee                    │\n  │ name       position  salary │\n──┼─────────────────────────────┼\n1 │ JEFFERY A  SERGEANT  101442 │\n=#"
},

{
    ...
    "category": "section",
    "text": "Julia\'s index notation permits named parameters. Each argument passed via named parameter is converted into a DataKnot and then made available as a label accessible anywhere in the pipeline.chicago_data[AMT=100000, It.AMT]\n#=>\n│ AMT    │\n┼────────┼\n│ 100000 │\n=#This technique permits complex pipelines to be re-used with different argument values. By convention we capitalize parameters so they standout from regular data labels.PaidOverAmt =\n  It.department >>\n  It.employee >>\n  Filter(It.salary .> It.AMT) >>\n  It.name\n\nchicago_data[PaidOverAmt, AMT=100000]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n=#With a different threshold amount, the result may change.chicago_data[PaidOverAmt, AMT=85000]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n2 │ DANIEL A  │\n=#"
},

{
    ...
    "category": "section",
    "text": "Suppose we want parameterized pipeline that could take other pipelines as arguments. Using Given, we could build a function that returns employee records with salary over a given amount.EmployeesOver(X) =\n  Given(:AMT => X,\n    It.department >>\n    It.employee >>\n    Filter(It.salary .> It.AMT))\n\nchicago_data[EmployeesOver(100000)]\n#=>\n  │ employee                    │\n  │ name       position  salary │\n──┼─────────────────────────────┼\n1 │ JEFFERY A  SERGEANT  101442 │\n=#But what if we wished to find employees with higher than average salary? Let\'s compute the average value as a pipeline.using Statistics: mean\nAvgSalary = mean.(It.department.employee.salary)\n\nchicago_data[AvgSalary]\n#=>\n│ It      │\n┼─────────┼\n│ 92314.0 │\n=#We could then combine these two pipelines.chicago_data[EmployeesOver(AvgSalary)]\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#Note that this combined expression is yet another pipeline that could be refined with further computation.chicago_data[\n  EmployeesOver(AvgSalary) >>\n  It.name]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n2 │ DANIEL A  │\n=#Unlike it\'s cousin Having, Given doesn\'t leak its definitions. Specifically, It.amt is not available outside EmployeesOver().chicago_data[\n  EmployeesOver(AvgSalary) >>\n  It.amt]\n#-> ERROR: cannot find amt ⋮"
},

{
    "location": "start/#More-Aggregates-1",
    "page": "Getting Started",
    "title": "More Aggregates",
    "category": "section",
    "text": "There are other aggregate functions, such as Min, Max, and Sum. They could be used to create a statistical measure.using Statistics: mean\nStats(X) =\n  Record(\n    :count => Count(X),\n    :mean => floor.(Int, mean.(X)),\n    :min => Min(X),\n    :max => Max(X),\n    :sum => Sum(X))\n\nchicago_data[\n  :salary_stats_for_all_employees =>\n     Stats(It.department.employee.salary)]\n#=>\n│ salary_stats_for_all_employees      │\n│ count  mean   min    max     sum    │\n┼─────────────────────────────────────┼\n│     3  92314  80016  101442  276942 │\n=#These statistics could be run by department.chicago_data[\n  It.department >>\n  Record(\n    It.name,\n    :salary_stats =>\n      Stats(It.employee.salary))]\n#=>\n  │ department                              │\n  │ name    salary_stats                    │\n──┼─────────────────────────────────────────┼\n1 │ POLICE  2, 90729, 80016, 101442, 181458 │\n2 │ FIRE    1, 95484, 95484, 95484, 95484   │\n=#"
},

{
    ...
    "title": "Paging Data",
    "category": "section",
    "text": "Sometimes query results can be quite large. In this case it\'s helpful to Take or Drop items from the input stream. Let\'s start by listing all 3 employees of our toy database.Employee = It.department.employee\nchicago_data[Employee]\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ NANCY A    POLICE OFFICER     80016 │\n3 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#To return up to the 2nd employee record, we use Take.chicago_data[Employee >> Take(2)]\n#=>\n  │ employee                          │\n  │ name       position        salary │\n──┼───────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT        101442 │\n2 │ NANCY A    POLICE OFFICER   80016 │\n=#A negative index can be used to count records from the end of the pipeline\'s input. So, to return up to, but not including, the very last item in the stream, we could write:chicago_data[Employee >> Take(-1)]\n#=>\n  │ employee                          │\n  │ name       position        salary │\n──┼───────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT        101442 │\n2 │ NANCY A    POLICE OFFICER   80016 │\n=#To return the last record of the pipeline\'s input, we could Drop up to the last item in the stream:chicago_data[Employee >> Drop(-1)]\n#=>\n  │ employee                           │\n  │ name      position          salary │\n──┼────────────────────────────────────┼\n1 │ DANIEL A  FIRE FIGHTER-EMT   95484 │\n=#"
},
...

{
    ...
    "category": "type",
    "text": "BlockOf(eshp::AbstractShape, card::Cardinality=x0toN)\n\nShape of a BlockVector.\n\n\n\n\n\n"
},

{
    "location": "shapes/#DataKnots.HasLabel",
    "page": "Monadic Signature",
    "title": "DataKnots.HasLabel",
    "category": "type",
    "text": "shp |> HasLabel(::Symbol)\n\n\n\n\n\n"
},
...
{
    "location": "pipelines/#DataKnots.Given-Tuple{Any,Vararg{Any,N} where N}",
    "page": "Pipeline Algebra",
...

{
    ...
    "category": "type",
    "text": "Pipeline(op, args...)\n\nA pipeline is a query transformation.  Specifically, it takes a query that maps origin to input and generates a query that maps origin to output.\n\nParameter op is a function that performs the transformation; args are extra arguments passed to the function.\n\nThe pipeline transforms an input query q by invoking op with the following arguments:\n\nop(env::Environment, q::Query, args...)\n\nThe result of op must again be the output query.\n\n\n\n\n\n"
},

{
    "location": "pipelines/#Base.run-Tuple{DataKnot,Any}",
    "page": "Pipeline Algebra",
    "title": "Base.run",
    "category": "method",
    "text": "run(db::DataKnot, F::AbstractPipeline; params...)\n\nRuns the pipeline with the given parameters.\n\n\n\n\n\n"
},
