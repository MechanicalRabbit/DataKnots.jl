...

{
    ...
    "title": "Thinking in DataKnots",
    "category": "section",
    "text": "DataKnots are a Julia library for working with computational pipelines. Each DataKnot is a container holding structured, often interrelated, vectorized data. Each Pipeline can be seen as a data knot transformation. Pipelines are assembled algebraically using pipeline primitives, which represent relationships among data, and combinators, which encapsulate logic.To start working with DataKnots, we import the package:using DataKnots"
},

{
    ...
    "category": "section",
    "text": "Consider a pipeline Hello that produces a DataKnot containing a string value, \"Hello World\". It is built using the Const primitive, which converts a Julia string value into a pipeline component. This pipeline can then be run() to produce its output.Hello = Const(\"Hello World\")\nrun(Hello)\n#=>\n│ DataKnot    │\n├─────────────┤\n│ Hello World │\n=#Consider another pipeline, Range(3). It is built with the Range combinator. When run(), it emits a sequence of integers from 1 to 3.run(Range(3))\n#=>\n  │ DataKnot │\n──┼──────────┤\n1 │        1 │\n2 │        2 │\n3 │        3 │\n=#Observe that Hello pipeline produces a singular value, while the Range(3) pipeline is plural. In the output notation for plural knots, indices are in the first column with values in remaining columns."
},
...

{
    ...
    "title": "Overview",
    "category": "section",
    "text": "Module DataKnots contains an implementation of an in-memory column store.using DataKnots:\n    @VectorTree,\n    BlockVector,\n    TupleVector,\n    column,\n    columns,\n    elements,\n    labels,\n    offsets,\n    partition,\n    width"
},
...
{
    "location": "vectors/#DataKnots.column-Tuple{DataKnots.TupleVector,Int64}",
    "page": "Column Store",
    "title": "DataKnots.column",
    "category": "method",
    "text": "column(::TupleVector, j::Int) :: AbstractVector\ncolumn(::TupleVector, lbl::Symbol) :: AbstractVector\n\nReturns the j-th column or the column with the given label.\n\n\n\n\n\n"
},

{
    "location": "vectors/#DataKnots.columns",
    "page": "Column Store",
    "title": "DataKnots.columns",
    "category": "function",
    "text": "columns(::TupleVector) :: Vector{AbstractVector}\n\nReturns a vector of column vectors.\n\n\n\n\n\n"
},

{
    "location": "vectors/#DataKnots.cursor",
    "page": "Column Store",
    "title": "DataKnots.cursor",
    "category": "function",
    "text": "cursor(::BlockVector) :: BlockCursor\ncursor(::BlockVector, ::Int) :: BlockCursor\n\nCreates a cursor at the beginning or at the given position of the BlockVector instance.\n\n\n\n\n\n"
},

{
    "location": "vectors/#DataKnots.elements",
    "page": "Column Store",
    "title": "DataKnots.elements",
    "category": "function",
    "text": "elements(::BlockVector) :: AbstractVector\n\nReturns the vector of elements.\n\n\n\n\n\n"
},

{
    "location": "vectors/#DataKnots.labels",
    "page": "Column Store",
    "title": "DataKnots.labels",
    "category": "function",
    "text": "labels(::TupleVector) :: Vector{Symbol}\n\nReturns a vector of column labels.  Returns an empty list if the columns have no labels assigned.\n\n\n\n\n\n"
},

{
    "location": "vectors/#DataKnots.locate",
    "page": "Column Store",
    "title": "DataKnots.locate",
    "category": "function",
    "text": "locate(::TupleVector, lbl::Symbol) :: Union{Int,Nothing}\n\nFinds the column position by its label.\n\n\n\n\n\n"
},

{
    "location": "vectors/#DataKnots.offsets",
    "page": "Column Store",
    "title": "DataKnots.offsets",
    "category": "function",
    "text": "offsets(::BlockVector) :: AbstractVector{Int}\n\nReturns the vector of offsets.\n\n\n\n\n\n"
},

{
    "location": "vectors/#DataKnots.width",
    "page": "Column Store",
    "title": "DataKnots.width",
    "category": "function",
    "text": "width(::TupleVector) :: Int\n\nReturns the number of columns.\n\n\n\n\n\n"
},
...

{
    ...
    "title": "Type System",
    "category": "section",
    "text": "Module DataKnot permits describing the shape of data and the signature of queries.using DataKnots:\n    OPT,\n    PLU,\n    REG,\n    AnyShape,\n    Cardinality,\n    InputMode,\n    InputShape,\n    NativeShape,\n    NoneShape,\n    OutputMode,\n    OutputShape,\n    RecordShape,\n    Signature,\n    bound,\n    cardinality,\n    decorate,\n    domain,\n    fits,\n    ibound,\n    idomain,\n    imode,\n    ishape,\n    isoptional,\n    isplural,\n    isregular,\n    mode,\n    shape"
},
...

{
    ...
    "title": "Overview",
    "category": "section",
    "text": "In DataKnots, structured data is stored in a column-oriented format, serialized using specialized composite vector types.  Consequently, operations on data take the form of vectorized functions.Module DataKnots implements an interface of vectorized transformations called Query and provives a rich library of query primitives and combinators.using DataKnots:\n    @VectorTree,\n    as_block,\n    chain_of,\n    column,\n    decode_missing,\n    decode_tuple,\n    decode_vector,\n    flat_block,\n    in_block,\n    in_tuple,\n    lift,\n    lift_block,\n    lift_const,\n    lift_null,\n    lift_to_block,\n    lift_to_block_tuple,\n    lift_to_tuple,\n    pass,\n    pull_block,\n    pull_every_block,\n    tuple_of"
},
