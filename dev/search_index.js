...

{
    ...
    "category": "section",
    "text": "Returning only wanted input can be done with Filter(). Here we list department names who have exactly one employee. Observe again that the argument provided to Filter is itself a pipeline.run(ChicagoData,\n    It.department\n    >> Filter(EmployeeCount .== 1)\n    >> Record(It.name, EmployeeCount))\n#=>\n  │ department  │\n  │ name  count │\n──┼─────────────┤\n1 │ FIRE      1 │\n=#In in pipeline expressions, the broadcast variant of common operators, such as .== are to be used. Forgetting the period is an easy mistake to make and the error message can be unhelpful.run(ChicagoData,\n    It.department\n    >> Filter(EmployeeCount == 1)\n    >> Record(It.name, EmployeeCount))\n#=>\nERROR: AssertionError: eltype(input) <: AbstractVector\n=#Let\'s define a GT100K pipeline to decide if an employee\'s salary is greater than 100K. The computation is also labeled.GT100K =\n  :gt100k =>\n    It.salary .> 100000\n\nrun(ChicagoData,\n    It.department.employee\n    >> Record(It.name, It.salary, GT100K))\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┤\n1 │ JEFFERY A  101442    true │\n2 │ NANCY A     80016   false │\n3 │ DANIEL A    95484   false │\n=#Since Filter uses takes boolean valued pipeline for an argument, we could use GTK100K to filter employees.run(ChicagoData,\n    It.department.employee\n    >> Filter(GT100K)\n    >> It.name)\n#=>\n  │ name      │\n──┼───────────┤\n1 │ JEFFERY A │\n=#"
},
...

{
    ...
    "title": "Paging",
    "category": "section",
    "text": "Sometimes query results can be quite large. In this case it\'s helpful to Take or Drop the first few items from a stream. Let\'s start by listing all 3 employees of our toy database.run(ChicagoData, It.department.employee)\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┤\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ NANCY A    POLICE OFFICER     80016 │\n3 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#To return the first 2 employee records, we use Take.run(ChicagoData,\n    It.department.employee\n    >> Take(2))\n#=>\n  │ employee                          │\n  │ name       position        salary │\n──┼───────────────────────────────────┤\n1 │ JEFFERY A  SERGEANT        101442 │\n2 │ NANCY A    POLICE OFFICER   80016 │\n=#"
},
