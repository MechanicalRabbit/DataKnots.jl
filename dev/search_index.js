...

{
    ...
    "title": "DataKnots Tutorial",
    "category": "section",
    "text": "DataKnots is an embedded query language designed so that accidental programmers could more easily solve complex data analysis tasks.This tutorial shows how typical query operations can be performed upon a simplified in-memory dataset. For initial releases, DataKnots will not include have methods to read/write common data formats (such as CSV or DataFrames). Contributors are welcome."
},

{
    ...
    "category": "section",
    "text": "Consider a tiny cross-section of public data from Chicago, represented as nested NamedTuple and Vector objects.chicago_data =\n  (department = [\n    (name = \"POLICE\",\n     employee = [\n      (name = \"JEFFERY A\", position = \"SERGEANT\",\n       salary = 101442),\n      (name = \"NANCY A\", position = \"POLICE OFFICER\",\n       salary = 80016)]),\n    (name = \"FIRE\",\n     employee = [\n      (name = \"DANIEL A\", position = \"FIRE FIGHTER-EMT\",\n       salary = 95484)])],);In this hierarchical Chicago dataset, the root is a NamedTuple with an entry :department, which is a Vector department records, and so on. Notice that the label name occurs both within the context of a department and an employee record.To query this dataset, we convert it into a DataKnot, or knot.using DataKnots\nchicago = DataKnot(chicago_data)"
},

{
    ...
    "category": "section",
    "text": "Let\'s say we want to return the list of department names from this dataset. We query the chicago knot using Julia\'s index notation and the query It.department.name.department_names = chicago[It.department.name]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#The output, department_names, is also a DataKnot. The content of this output knot could be accessed via get function.get(department_names)\n#-> [\"POLICE\", \"FIRE\"]"
},

{
    ...
    "title": "Navigation",
    "category": "section",
    "text": "In DataKnot queries, It means \"use the current input\". The dotted notation lets one navigate the hierarchy. Let\'s continue our dataset exploration by listing employee names.chicago[It.department.employee.name]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n2 │ NANCY A   │\n3 │ DANIEL A  │\n=#Navigation context matters. For example, employee tuples are not directly accessible from the root of the dataset. When a label can\'t be found, an appropriate error message is displayed.chicago[It.employee]\n#-> ERROR: cannot find \"employee\" ⋮Instead, employee tuples can be queried by navigating though department tuples. When tuples are returned, they is displayed with a tabular layout.chicago[It.department.employee]\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ NANCY A    POLICE OFFICER     80016 │\n3 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#Notice that nested lists traversed during navigation are flattened into a single output."
},

{
    ...
    "category": "section",
    "text": "Dotted navigations, such as It.department.name, are a syntax shorthand for the Get() primitive together with query composition (>>).chicago[Get(:department) >> Get(:name)]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#The Get() primitive returns values that match a given name. Query composition (>>) chains two queries serially, with the output of its first query as input to the second.chicago[Get(:department) >> Get(:employee)]\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ NANCY A    POLICE OFFICER     80016 │\n3 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#In this query algebra, It is the identity query with respect to composition (>>). The query It simply reproduces for its output what it recieves as its input. Hence, It can be woven into any composition without changing the result.chicago[It >> Get(:department) >> Get(:name)]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#This motivates our clever use of It as a syntax short hand.chicago[It.department.name]\n#=>\n  │ name   │\n──┼────────┼\n1 │ POLICE │\n2 │ FIRE   │\n=#This query, It.department.name, could be equivalently written Get(:department) >> Get(:name)."
},
...

{
    ...
    "category": "section",
    "text": "Returning values in tandem can be done with Record(). Let\'s improve the previous output by including each department\'s name alongside employee counts.chicago[\n    It.department >>\n    Record(It.name,\n           Count(It.employee))]\n#=>\n  │ department │\n  │ name    #B │\n──┼────────────┼\n1 │ POLICE   2 │\n2 │ FIRE     1 │\n=#Records can be nested. The following listing includes, for each department, employee names and their salary.chicago[\n    It.department >>\n    Record(It.name,\n           It.employee >>\n           Record(It.name,\n                  It.salary))]\n#=>\n  │ department                                │\n  │ name    employee                          │\n──┼───────────────────────────────────────────┼\n1 │ POLICE  JEFFERY A, 101442; NANCY A, 80016 │\n2 │ FIRE    DANIEL A, 95484                   │\n=#In this nested display, commas are used to separate fields and semi-colons separate values."
},

{
    "location": "tutorial/#Expressions-and-Output-Labels-1",
    "page": "DataKnots Tutorial",
    "title": "Expressions & Output Labels",
    "category": "section",
    "text": "Query expressions can be named and reused. Further, the output column of these named queries may be labeled using Julia\'s Pair syntax (=>). Let\'s define EmployeeCount to be the number of employees in a given department.EmployeeCount =\n    :employee_count =>\n        Count(It.employee)\n\nchicago[\n    It.department >>\n    Record(It.name,\n           EmployeeCount)]\n#=>\n  │ department             │\n  │ name    employee_count │\n──┼────────────────────────┼\n1 │ POLICE               2 │\n2 │ FIRE                 1 │\n=#Labels can be attached to an existing query using the Label primitive. This form is handy for use in successive query refinements (>>=).DeptCount = Count(It.department)\nDeptCount >>= Label(:dept_count)\n\nchicago[DeptCount]\n#=>\n│ dept_count │\n┼────────────┼\n│          2 │\n=#Besides providing a display title, labels also provide a way to access fields within a record.chicago[\n    Record(It, DeptCount) >>\n    It.dept_count]\n#=>\n│ dept_count │\n┼────────────┼\n│          2 │\n=#"
},

{
    ...
    "category": "section",
    "text": "Returning only wanted values can be done with Filter(). Here we list department names who have exactly one employee.chicago[\n    It.department >>\n    Filter(EmployeeCount .== 1) >>\n    Record(It.name, EmployeeCount)]\n#=>\n  │ department           │\n  │ name  employee_count │\n──┼──────────────────────┼\n1 │ FIRE               1 │\n=#In query expressions, the broadcast variant of common operators, such as .==, are to be used. Forgetting the period is an easy mistake to make and the resulting Julia language error message may not be helpful.chicago[\n    It.department >>\n    Filter(EmployeeCount == 1) >>\n    Record(It.name, EmployeeCount)]\n#=>\nERROR: AssertionError: eltype(input) <: AbstractVector\n=#Let\'s define GT100K to check if an employee\'s salary is greater than 100K. The output of this query component is also labeled.GT100K =\n    :gt100k =>\n        It.salary .> 100000\n\nchicago[\n    It.department.employee >>\n    Record(It.name, It.salary, GT100K)]\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┼\n1 │ JEFFERY A  101442    true │\n2 │ NANCY A     80016   false │\n3 │ DANIEL A    95484   false │\n=#Since Filter takes a boolean valued query for an argument, we could use GTK100K to filter employees.chicago[\n    It.department.employee >>\n    Filter(GT100K) >>\n    It.name]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n=#"
},

{
    ...
    "category": "section",
    "text": "This data discovery could have been done incrementally, with each intermediate query being fully runnable. Let\'s start our_query as a list of employees. We\'re not going to run it, but we could.our_query = It.department.employee\n#-> It.department.employeeLet\'s extend this query to compute if the salary is over 100k. Notice how query composition is tracked for us.GT100K = :gt100k => It.salary .> 100000\nour_query >>= Record(It.name, It.salary, GT100K)\n#=>\nIt.department.employee >>\nRecord(It.name, It.salary, :gt100k => It.salary .> 100000)\n=#Let\'s run our_query against the chicago knot.chicago[our_query]\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┼\n1 │ JEFFERY A  101442    true │\n2 │ NANCY A     80016   false │\n3 │ DANIEL A    95484   false │\n=#Since labeling permits direct Record access, we could further extend our_query to filter unwanted rows.our_query >>= Filter(It.gt100k)\n#=>\nIt.department.employee >>\nRecord(It.name, It.salary, :gt100k => It.salary .> 100000) >>\nFilter(It.gt100k)\n=#Let\'s run our_query again.chicago[our_query]\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┼\n1 │ JEFFERY A  101442    true │\n=#Well-tested queries may benefit from a Tag so that their definitions are suppressed in larger compositions.GT100K = Tag(:GT100K, :gt100k => It.salary .> 100000)\n#-> GT100KThis tagging can make subsequent compositions easier to read, when the definition of the named query is not being questioned.our_query = It.department.employee >>\n            Record(It.name, It.salary, GT100K)\n#=>\nIt.department.employee >> Record(It.name, It.salary, GT100K)\n=#Notice that the tag (:GT100K) is distinct from the data label (:gt100k), the tag names the query while the label names the output column.our_query >>= Filter(It.gt100k)\nchicago[our_query]\n#=>\n  │ employee                  │\n  │ name       salary  gt100k │\n──┼───────────────────────────┼\n1 │ JEFFERY A  101442    true │\n=#For the final step of our query\'s incremental construction, let\'s only show the employee\'s name that met the GT100K criteria.our_query >>= It.name\nchicago[our_query]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n=#As we see, queries can be combined in series or as arguments to make new queries. Queries can then be performed on a DataKnot to produce a new DataKnot. Hence, the construction and performance of a query are distinct and separate operations."
},

{
    "location": "tutorial/#Accessing-Data-1",
    "page": "DataKnots Tutorial",
    "title": "Accessing Data",
    "category": "section",
    "text": "Given any DataKnot, its content can be accessed via get. For scalar outputs, get returns a typed Julia value.get(chicago[Count(It.department)])\n#-> 2For simple lists, get returns a typed Vector.get(chicago[It.department.employee.name])\n#-> [\"JEFFERY A\", \"NANCY A\", \"DANIEL A\"]For more complex outputs, get may return a @VectorTree, a column-oriented storage for our DataKnot system.query = It.department >>\n        Record(It.name,\n               :employee_count => Count(It.employee))\nvt = get(chicago[query])\ndisplay(vt)\n#=>\n@VectorTree of 2 × (name = (1:1) × String, employee_count = (1:1) × Int):\n (name = \"POLICE\", employee_count = 2)\n (name = \"FIRE\", employee_count = 1)\n=#The @VectorTree datatype is considered an implemention detail, upon which specific input/output converters will be written."
},

{
    "location": "tutorial/#Query-Combinators-1",
    "page": "DataKnots Tutorial",
    "title": "Query Combinators",
    "category": "section",
    "text": "We\'ve seen how DataKnots\' queries are assembled algebraically: they either come from a set of atomic primitives or are built from other queries using combinators.Query primitives include the identity (It), constant values (like 100000), and data navigation via Get(:Symbol). Besides query composition (>>), query combinators include Count(), Record(), Label(), Filter(), Tag() and broadcast operators such as equality (.==) and greater than (.>).This next section describes additional primitives and combinators included with DataKnots\' core library."
},

{
    ...
    "category": "section",
    "text": "Aggregates, such as Count may be used as a query primitive, providing incremental refinement without additional nesting. In this next example, Count takes an input of filtered employees, and returns the size of its input.chicago[\n    It.department.employee >>\n    Filter(It.salary .> 100000) >>\n    Count]\n#=>\n│ It │\n┼────┼\n│  1 │\n=#Aggregate query primitives operate contextually. In the following example, Count is performed relative to each department.chicago[\n    It.department >>\n    Record(\n        It.name,\n        :over_100k =>\n            It.employee >>\n            Filter(It.salary .> 100000) >>\n            Count)]\n#=>\n  │ department        │\n  │ name    over_100k │\n──┼───────────────────┼\n1 │ POLICE          1 │\n2 │ FIRE            0 │\n=#Note that in the query It.department.employee >> Count, the Count primitive aggregates the number of employees across all departments. This doesn\'t change even if we add parentheses:chicago[It.department >> (It.employee >> Count)]\n#=>\n│ It │\n┼────┼\n│  3 │\n=#To count employees in each department, we use Each(). This combinator applies its input elementwise to its argument. Therefore, we get two counts, one for each department.chicago[It.department >> Each(It.employee >> Count)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  1 │\n=#Naturally, we could use the Count() query combinator to get the same result.chicago[It.department >> Count(It.employee)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  1 │\n=#Which form of an aggregate to use depends upon what is notationally convenient. For incremental construction, being able to simply append >> Count is often very helpful.our_query = It.department.employee\nchicago[our_query >> Count]\n#=>\n│ It │\n┼────┼\n│  3 │\n=#We could then refine the query, and run the exact same command.our_query >>= Filter(It.salary .> 100000)\nchicago[our_query >> Count]\n#=>\n│ It │\n┼────┼\n│  1 │\n=#"
},

{
    "location": "tutorial/#Function-broadcasting-1",
    "page": "DataKnots Tutorial",
    "title": "Function broadcasting",
    "category": "section",
    "text": "Besides operators, such as greater than (.>), arbitrary functions can also be used as a query combinator with the broadcast notation. Let\'s define a function to extract an employee\'s first name.fname(x) = titlecase(split(x)[1])\nfname(\"NANCY A\")\n#-> \"Nancy\"This fname function can then be used within a query expression to return first names of all employees.chicago[\n    It.department.employee >>\n    fname.(It.name) >>\n    Label(:first_name)]\n#=>\n  │ first_name │\n──┼────────────┼\n1 │ Jeffery    │\n2 │ Nancy      │\n3 │ Daniel     │\n=#Aggregate Julia functions, such as mean, can also be used.using Statistics: mean\n\nchicago[\n    It.department >>\n    Record(\n        It.name,\n        :mean_salary => mean.(It.employee.salary))]\n#=>\n  │ department          │\n  │ name    mean_salary │\n──┼─────────────────────┼\n1 │ POLICE      90729.0 │\n2 │ FIRE        95484.0 │\n=#The conversion of a function into a combinator is accomplished by Lift, as documented in the reference. How a lifted function is treated as a query combinator depends upon that function\'s input and output signature."
},

{
    ...
    "category": "section",
    "text": "Suppose we\'d like a list of employee names together with the corresponding department name. The naive approach won\'t work, because department is not a label in the context of an employee.chicago[\n    It.department >>\n    It.employee >>\n    Record(It.name, It.department.name)]\n#-> ERROR: cannot find \"department\" ⋮This can be overcome by using Keep to label an expression\'s result, so that it is available within subsequent computations.chicago[\n    It.department >>\n    Keep(:dept_name => It.name) >>\n    It.employee >>\n    Record(It.name, It.dept_name)]\n#=>\n  │ employee             │\n  │ name       dept_name │\n──┼──────────────────────┼\n1 │ JEFFERY A  POLICE    │\n2 │ NANCY A    POLICE    │\n3 │ DANIEL A   FIRE      │\n=#This pattern also emerges with aggregate computations which need to be done in a parent scope. For example, let\'s compute employees with a higher than average salary for their department.using Statistics: mean\nchicago[\n    It.department >>\n    Keep(:mean_salary => mean.(It.employee.salary)) >>\n    It.employee >>\n    Filter(It.salary .> It.mean_salary)]\n#=>\n  │ employee                    │\n  │ name       position  salary │\n──┼─────────────────────────────┼\n1 │ JEFFERY A  SERGEANT  101442 │\n=#In this last query, mean simply can\'t be moved into Filter\'s argument, since this argument is evaluated for each employee."
},
...

{
    ...
    "category": "section",
    "text": "Julia\'s index notation permits named parameters. Each argument passed via named parameter is converted into a DataKnot and then made available as a label accessible anywhere in the query.chicago[AMT=100000, It.AMT]\n#=>\n│ AMT    │\n┼────────┼\n│ 100000 │\n=#This technique permits complex queries to be re-used with different argument values. By convention we capitalize parameters so they standout from regular data labels.PaidOverAmt =\n    It.department >>\n    It.employee >>\n    Filter(It.salary .> It.AMT) >>\n    It.name\n\nchicago[PaidOverAmt, AMT=100000]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n=#What if we want to return employee names who have a greater than average salary? This average could be computed first.using Statistics\nmean_salary = chicago[mean.(It.department.employee.salary)]\n#=>\n│ It      │\n┼─────────┼\n│ 92314.0 │\n=#Then, this value could be used as a query parameter.chicago[PaidOverAmt, AMT=mean_salary]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n2 │ DANIEL A  │\n=#While this approach works, it performs composition outside of the query language. If the dataset changes, a new mean_salary would have to be computed before the query above could be performed."
},

{
    "location": "tutorial/#Parameterized-Queries-1",
    "page": "DataKnots Tutorial",
    "title": "Parameterized Queries",
    "category": "section",
    "text": "Suppose we want parameterized query that could take other queries as arguments. Using Given, we could build a query that returns employee records with salary over a given amount.EmployeesOver(X) =\n    Given(:AMT => X,\n        It.department >>\n        It.employee >>\n        Filter(It.salary .> It.AMT))\n\nchicago[EmployeesOver(100000)]\n#=>\n  │ employee                    │\n  │ name       position  salary │\n──┼─────────────────────────────┼\n1 │ JEFFERY A  SERGEANT  101442 │\n=#But what if we wished to find employees with higher than average salary? Let\'s compute the average value as a query.using Statistics: mean\nAvgSalary = mean.(It.department.employee.salary)\n\nchicago[AvgSalary]\n#=>\n│ It      │\n┼─────────┼\n│ 92314.0 │\n=#We could then combine these two queries.chicago[EmployeesOver(AvgSalary)]\n#=>\n  │ employee                            │\n  │ name       position          salary │\n──┼─────────────────────────────────────┼\n1 │ JEFFERY A  SERGEANT          101442 │\n2 │ DANIEL A   FIRE FIGHTER-EMT   95484 │\n=#Note that this combined expression is yet another query that could be further refined.chicago[EmployeesOver(AvgSalary) >> It.name]\n#=>\n  │ name      │\n──┼───────────┼\n1 │ JEFFERY A │\n2 │ DANIEL A  │\n=#Unlike its cousin Having, Given doesn\'t leak its definitions. Specifically, It.amt is not available outside EmployeesOver().chicago[EmployeesOver(AvgSalary) >> It.amt]\n#-> ERROR: cannot find \"amt\" ⋮"
},

{
    "location": "tutorial/#Aggregate-Combinators-1",
    "page": "DataKnots Tutorial",
    "title": "Aggregate Combinators",
    "category": "section",
    "text": "There are other aggregate combinators, such as Min, Max, and Sum. They could be used to create a statistical measure.using Statistics: mean\nStats(X) =\n    Record(\n        :count => Count(X),\n        :mean => floor.(Int, mean.(X)),\n        :min => Min(X),\n        :max => Max(X),\n        :sum => Sum(X))\n\nchicago[\n    :salary_stats_for_all_employees =>\n        Stats(It.department.employee.salary)]\n#=>\n│ salary_stats_for_all_employees      │\n│ count  mean   min    max     sum    │\n┼─────────────────────────────────────┼\n│     3  92314  80016  101442  276942 │\n=#These statistics could be computed for each department.chicago[\n    It.department >>\n    Record(\n        It.name,\n        :salary_stats => Stats(It.employee.salary))]\n#=>\n  │ department                              │\n  │ name    salary_stats                    │\n──┼─────────────────────────────────────────┼\n1 │ POLICE  2, 90729, 80016, 101442, 181458 │\n2 │ FIRE    1, 95484, 95484, 95484, 95484   │\n=#To inspect the definition of Stats you could build a query, Stats(It), and show it.Stats(It)\n#=>\nRecord(:count => Count(It),\n       :mean => floor.(Int, mean.(It)),\n       :min => Min(It),\n       :max => Max(It),\n       :sum => Sum(It))\n=#Parameterized queries, such as Stats, can also be tagged. Then, when they are displayed with an argument, the definition is suppressed.Stats(X) =\n  Tag(:Stats, (X,),\n    Record(\n        :count => Count(X),\n        :mean => floor.(Int, mean.(X)),\n        :min => Min(X),\n        :max => Max(X),\n        :sum => Sum(X)))\nStats(It)\n#-> Stats(It)Suppressing the definition of parameterized queries such as Stats makes the incremental composition easier to follow.MyQuery = It.department\nMyQuery >>= Stats(It.employee.salary)\n#=>\nIt.department >> Stats(It.employee.salary)\n=#"
},
...

{
    ...
    "category": "section",
    "text": "A DataKnot, or just knot, is a container having structured, vectorized data.For this conceptual guide, we\'ll start with a trivial knot, void as our initial data source. The void knot encapsulates the value nothing, which will serve as the input for our queries.void = DataKnot(nothing)\n#=>\n│ It │\n┼────┼\n│    │\n=#"
},

{
    ...
    "category": "section",
    "text": "Any Julia value could be converted to a query using the Lift query constructor. Queries constructed this way are constant: for each input they receive, they produce the given value. Consider the query Hello, lifted from the string value \"Hello World\".Hello = Lift(\"Hello World\")To query void with Hello, we use indexing notation void[Hello]. In this case, Hello receives nothing from void and produces the value, \"Hello World\".void[Hello]\n#=>\n│ It          │\n┼─────────────┼\n│ Hello World │\n=#A vector lifted to a constant query will produce plural output. Consider Lift(\'a\':\'c\'), constructed by lifting a unit range to a constant query.void[Lift(\'a\':\'c\')]\n#=>\n  │ It │\n──┼────┼\n1 │ a  │\n2 │ b  │\n3 │ c  │\n=#"
},

{
    ...
    "title": "Composition & Identity",
    "category": "section",
    "text": "Two queries can be connected sequentially using the composition combinator (>>). Consider the composition, Lift(1:3) >> Hello. Since Hello produces a value for each input element, preceding it with Lift(1:3) generates three copies of \"Hello World\".void[Lift(1:3) >> Hello]\n#=>\n  │ It          │\n──┼─────────────┼\n1 │ Hello World │\n2 │ Hello World │\n3 │ Hello World │\n=#If we compose two plural queries, Lift(1:2) and Lift(\'a\':\'c\'), the output will contain the elements of \'a\':\'c\' repeated twice.void[Lift(1:2) >> Lift(\'a\':\'c\')]\n#=>\n  │ It │\n──┼────┼\n1 │ a  │\n2 │ b  │\n3 │ c  │\n4 │ a  │\n5 │ b  │\n6 │ c  │\n=#The identity with respect to query composition is called It. This primitive can be composed with any query without changing the query\'s output.void[Hello >> It]\n#=>\n│ It          │\n┼─────────────┼\n│ Hello World │\n=#The identity primitive, It, can be used to construct queries which rely upon the output from previous processing.Increment = It .+ 1\nvoid[Lift(1:3) >> Increment]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  3 │\n3 │  4 │\n=#In DataKnots, queries are built algebraically, starting with query primitives, such as constants (Lift) and identity (It), and then arranged with with combinators, such as composition (>>). This lets us define sophisticated query components and remix them in creative ways."
},

{
    "location": "thinking/#Julia-Functions-1",
    "page": "Thinking in Combinators",
    "title": "Julia Functions",
    "category": "section",
    "text": "Consider the function double(x) that, when applied to a Number, produces a Number:double(x) = 2x\ndouble(3) #-> 6What we want is an analogue to double that, instead of operating on numbers, operates on queries. Such functions are called query combinators. We can convert any Julia function to a query combinator by passing the function and its arguments to Lift.Double(X) = Lift(double, (X,))Once lifted, Double is a combinator that doubles its argument. In particular, Double(It) is a query that doubles its input.void[Lift(1:3) >> Double(It)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  4 │\n3 │  6 │\n=#Using Julia\'s broadcast syntax, this lifting could be automated.void[Lift(1:3) >> double.(It)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  4 │\n3 │  6 │\n=#Automatic lifting also applies to built-in Julia operators (+) and values (1). The expression It .+ 1 is a query component that increments each of it\'s input elements.void[Lift(1:3) >> (It .+ 1)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │  3 │\n3 │  4 │\n=#One can also define combinators as query expressions. However, be sure to cast each argument using Lift.OneTo(N) = UnitRange.(1, Lift(N))Note that this lifted function is vector-valued. Therefore, the result is a plural output.void[OneTo(3)]\n#=>\n  │ It │\n──┼────┼\n1 │  1 │\n2 │  2 │\n3 │  3 │\n=#When Julia values and functions are lifted, the type signature is inspected to discover how it should interact with query flow. A flow is singular if it could have at most one element; else, it is plural. Furthermore, if a flow must have at least one element then it is mandatory; else, it is optional.Type Singular Mandatory\nVector{T} No No\nUnion{T, Missing} Yes No\n{T} Yes YesThough this inspection, query combinators can be automatically constructed from Julia functions. This lets us access Julia\'s rich statistical and data processing functions from our queries."
},

{
    ...
    "title": "Query Combinators",
    "category": "section",
    "text": "There are operations which cannot be automatically lifted from Julia functions. These require knowledge DataKnot flows, context, and other internal details. We\'ve met two of them, Lift itself and query composition (>>).Operations that cannot be lifted include navigation, filtering, sorting, grouping, paging, and many others."
},

{
    "location": "thinking/#Aggregate-Primitives-and-Combinators-1",
    "page": "Thinking in Combinators",
    "title": "Aggregate Primitives & Combinators",
    "category": "section",
    "text": "So far queries have been elementwise; that is, for each input element, they produce zero or more output elements. Consider now the Count primitive has a singular output for its entire input.void[OneTo(3) >> Count]\n#=>\n│ It │\n┼────┼\n│  3 │\n=#This form of aggregation is helpful when extending compositions. Let\'s start with the query, OneTo(3) >> OneTo(It).void[OneTo(3) >> OneTo(It)]\n#=>\n  │ It │\n──┼────┼\n1 │  1 │\n2 │  1 │\n3 │  2 │\n4 │  1 │\n5 │  2 │\n6 │  3 │\n=#By simply appending >> Sum we could aggregate the input.void[OneTo(3) >> OneTo(It) >> Sum]\n#=>\n│ It │\n┼────┼\n│ 10 │\n=#What if we wanted to produce sums by the outer query, OneTo(3)? Since query composition (>>) is associative, adding parenthesis around OneTo(It) >> Sum will not change the result.void[OneTo(3) >> (OneTo(It) >> Sum)]\n#=>\n│ It │\n┼────┼\n│ 10 │\n=#Instead of using parenthesis, we wrap OneTo(It) >> Sum with the Each combinator, which evaluates its argument elementwise.void[OneTo(3) >> Each(OneTo(It) >> Sum)]\n#=>\n  │ It │\n──┼────┼\n1 │  1 │\n2 │  3 │\n3 │  6 │\n=#Following is an equivalent query, using the Sum combinator.void[OneTo(3) >> Sum(OneTo(It))]\n#=>\n  │ It │\n──┼────┼\n1 │  1 │\n2 │  3 │\n3 │  6 │\n=#Julia language aggregates, such as mean, can be easily lifted. DataKnots automatically converts the plural query parameter into the vector argument required by the native aggregate.using Statistics\nMean(X) = mean.(X)\nvoid[Mean(OneTo(3) >> Sum(OneTo(It)))]\n#=>\n│ It      │\n┼─────────┼\n│ 3.33333 │\n=#To use Mean as a query primitive, we use Then to build a query that aggregates from its input. Next, we register this query so it is chosen when Mean is converted to a query via Lift.DataKnots.Lift(::typeof(Mean)) = DataKnots.Then(Mean)Once these are done, one could take an average of sums as follows:void[Lift(1:3) >> Sum(OneTo(It)) >> Mean]\n#=>\n│ It      │\n┼─────────┼\n│ 3.33333 │\n=#In DataKnots, aggregate operations are naturally expressed as query primitives or query combinators. Moreover, custom aggregates can be easily constructed as native Julia functions and lifted into the query algebra."
},
...

{
    ...
    "title": "Paging Data",
    "category": "section",
    "text": "Similar to Filter, the Take and Drop combinators can be used to slice an input stream: Drop is used to skip over input, while Take ignores output past a particular point.void[OneTo(9) >> Drop(3) >> Take(3)]\n#=>\n  │ It │\n──┼────┼\n1 │  4 │\n2 │  5 │\n3 │  6 │\n=#Unlike Filter, slicing combinators are not elementwise, even if they reproduce elements from the source. Further, the argument to Take is evaluated in the context of the input\'s origin. In the next example, It refers to elements of the outer loop, OneTo.void[OneTo(3) >> Each(Lift(\'a\':\'c\') >> Take(It))]\n#=>\n  │ It │\n──┼────┼\n1 │ a  │\n2 │ a  │\n3 │ b  │\n4 │ a  │\n5 │ b  │\n6 │ c  │\n=#What if we want to grab the 1st half of an input stream? Let\'s define FirstHalf as a combinator that builds a query returning the first half of an input stream.FirstHalf(X) = Each(X >> Take(Count(X) .÷ 2))\nvoid[FirstHalf(OneTo(6))]\n#=>\n  │ It │\n──┼────┼\n1 │  1 │\n2 │  2 │\n3 │  3 │\n=#Using Then, this combinator could be used as a query primitive.DataKnots.Lift(::typeof(FirstHalf)) = DataKnots.Then(FirstHalf)\nvoid[OneTo(6) >> FirstHalf]\n#=>\n  │ It │\n──┼────┼\n1 │  1 │\n2 │  2 │\n3 │  3 │\n=#The slicing combinators are different from filtering in that they evaluate their arguments at the origin."
},

{
    ...
    "category": "section",
    "text": "Data objects can be created using the Record combinator. Calculations could be performed on record sets.GM = Record(:name => \"GARRY M\", :salary => 260004)\nvoid[GM]\n#=>\n│ name     salary │\n┼─────────────────┼\n│ GARRY M  260004 │\n=#Field access is possible via Get query constructor, which takes a label\'s name. Here Get(:name) is a singular elementwise query that returns the value of a given label when found.void[GM >> Get(:name)]\n#=>\n│ name    │\n┼─────────┼\n│ GARRY M │\n=#For syntactic convenience, It can be used for dotted access.void[GM >> It.name]\n#=>\n│ name    │\n┼─────────┼\n│ GARRY M │\n=#The Label combinator provides a name to any expression.void[Lift(\"Hello World\") >> Label(:greeting)]\n#=>\n│ greeting    │\n┼─────────────┼\n│ Hello World │\n=#Alternatively, Julia\'s pair constructor (=>) and and a Symbol denoted by a colon (:) can be used to label an expression.Hello =\n  :greeting => Lift(\"Hello World\")\n\nvoid[Hello]\n#=>\n│ greeting    │\n┼─────────────┼\n│ Hello World │\n=#Records can be plural. Here is a table of obvious statistics.Stats = Record(:n¹=>It, :n²=>It.*It, :n³=>It.*It.*It)\nvoid[Lift(1:3) >> Stats]\n#=>\n  │ n¹  n²  n³ │\n──┼────────────┼\n1 │  1   1   1 │\n2 │  2   4   8 │\n3 │  3   9  27 │\n=#By accessing names, calculations can be performed on records.void[Lift(1:3) >> Stats >> (It.n² .+ It.n³)]\n#=>\n  │ It │\n──┼────┼\n1 │  2 │\n2 │ 12 │\n3 │ 36 │\n=#Any values can be used within a Record, including other records and plural values.Schedule =\n    :work_schedule =>\n        Record(:staff => Record(:name => \"Jim Rockford\",\n                                :phone => \"555-2368\"),\n               :workday => Lift([\"Su\", \"M\",\"Tu\", \"F\"]))\n\nvoid[Schedule]\n#=>\n│ work_schedule                        │\n│ staff                   workday      │\n┼──────────────────────────────────────┼\n│ Jim Rockford, 555-2368  Su; M; Tu; F │\n=#Access to values via label also works hierarchical.void[Schedule >> It.staff.name]\n#=>\n│ name         │\n┼──────────────┼\n│ Jim Rockford │\n=#In DataKnots, records are used to generate tabular data. Using nested records, it is possible to represent complex, hierarchical data. It is then possible to access and compute with this data."
},
